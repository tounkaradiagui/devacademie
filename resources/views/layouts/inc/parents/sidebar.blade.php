      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="{{url('parent/signup')}}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Liste de canditatures</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="{{url('parent/signup-create')}}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Ajouter canditature</p>
                </a>
              </li>
            </ul>
          </li>
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="{{url('parent/factures')}}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Mes factures</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="{{url('parent/versement')}}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Liste Versement</p>
                </a>
              </li>
         ...
         <li class="nav-item">
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="{{url('parent/mon-profile')}}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
