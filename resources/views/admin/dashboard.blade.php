            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">
                  ...
                  Nombres et Enseignants par classe
                </h3>
                <div class="card-tools">
                  <ul class="nav nav-pills ml-auto">
                    <li class="nav-item">
                      <a class="nav-link active" href="#revenue-chart" data-toggle="tab">Bars</a>
                    </li>
                    <li class="nav-item">
                      <a class="nav-link" href="#sales-chart" data-toggle="tab">Graphique</a>
                    </li>
                  </ul>
                </div>
              </div><!-- /.card-header -->
