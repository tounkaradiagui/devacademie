          ...
          <div class="modal-dialog">
            <div class="modal-content">
              <div class="modal-header" style="background-color: #0050e3;">
                <h5 class="modal-title text-white" id="exampleModalLabel">Ajouter une année</h5>
    ...
    @if (session()->has("success"))
        ...
        <div class="row">
            <div class="card-header text-white" style="background-color: #0050e3;">
                ...
                <a href="#" data-bs-toggle="modal" data-bs-target="#ajouter_annee" class="btn btn-success btn-sm float-end text-white" >Ajouter</a>
            </div>
