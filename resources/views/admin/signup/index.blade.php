...
<div class="card">
    <div class="card-header" style="background-color: #0B6623 ;">
        <h4 style="text-align: center; color: white;">La liste de pré-inscriptions 
          <a href="#" data-bs-toggle="modal" data-bs-target="#valider_candidat" class="btn btn-primary btn-sm float-end text-white" >Ajouter</a>
        </h4>
    </div>
    <div class="container">
            ...
            <tbody>
                ...
                <tr>
                  ...
                  <td class="text-center">
                    <a href="{{url('admin/edit-candidat/'.$display->id)}}" title="Valider la candidature"><i class='fas fa-check-double' style='font-size:20px; color:#0B6623 '></i></a>
                  </td>
                </tr>
                @endforeach
            </tbody>
 ...
 <script type="text/javascript" charset="utf8" src="https://cdn.datatables.net/1.12.1/js/jquery.dataTables.js"></script>
  ...
  <script>
        $(document).on('click', '#cissan', function(){
