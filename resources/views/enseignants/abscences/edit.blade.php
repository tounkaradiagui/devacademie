            ...
            <div class="container">
                <div class="card">
                    <div class="card-header text-white" style="background-color: #0050e3;">
                        <h5>Liste de notes<a href="{{ url('enseignant/absences') }}"  class="btn btn-success btn-sm text-white float-end" >Retour</a></h5>
                    </div>
                    <div class="card-body">
                        <form action="{{ url('enseignant/update-absences/'.$display->id) }}" method="post">
                            @csrf
                            @method('PUT')
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="col-md-6">
                                                ...
                                                <input type="text" name="note" value="{{$display->note}}" class="form-control">
                                            </div>

                                            <div class="col-md-6">
                                                <label for="nom_trimestre" class="float-start mt-2">Matière</label><br>
                                                <input type="text" name="note" value="{{$display->matiere}}" class="form-control">
                                            </div>
                                        </div>
